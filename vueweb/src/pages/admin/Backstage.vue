  ...
  <div class="Backstage" :style="{width:width+'px',height:height+'px'}">
    <div class="bsLeft" style="float: left">
      ...
      <ul :style="{height:(height-70)+'px'}">
        ...
        <li @click="navTo('/backstage/editSeller')" :class="{selected:curPath==='/backstage/editSeller'}">商家管理</li>
        <li @click="navTo('/backstage/editActivity')" :class="{selected:curPath==='/backstage/editActivity'}">活动审核</li>
    ...
    <div class="bsRight">
      ...
      <transition name="router-fade" mode="out-in">
        <router-view
            :style="{height:(height-70)+'px',overflowY:'scroll',width:'100%',padding:'20px',backgroundColor:'#f6f5fa'}"></router-view>
      </transition>
    </div>
  </div>
</template>
